...
# Función principal para controlar el número de procesos (núcleos)
...
if __name__ == "__main__":
    cadena = "a" * 100 + "p"  # Cadena de un millón de caracteres antes de la 'ñ'
    
    num_procesos = int(input("Introduce el número de procesos (núcleos) que deseas utilizar: "))
    print(f"Utilizando {num_procesos} núcleos.")
